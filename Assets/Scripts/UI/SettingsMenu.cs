...
public class SettingsMenu : MonoBehaviour
{
    ...
    public const string InvertYKey = "Settings.Controlls.InvertY";
    public const string MouseSensitivityKey = "Settings.Controlls.Sensitivity.Mouse";
    public const string ControllerSensitivityKey = "Settings.Controlls.Sensitivity.Controller";
